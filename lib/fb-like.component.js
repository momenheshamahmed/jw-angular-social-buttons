...
var FbLikeComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], FbLikeComponent.prototype, "url", void 0);
    FbLikeComponent = __decorate([
        core_1.Component({
            selector: 'fb-like',
            template: "<div class=\"fb-share-button\" [attr.data-href]=\"url\" data-layout=\"button_count\"  data-mobile-iframe=\"true\"></div>"
        })
    ], FbLikeComponent);
